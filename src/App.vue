<script setup>
import { HeatMapComponent as EjsHeatmap, Adaptor } from "@syncfusion/ej2-vue-heatmap";
...
const xAxis = { labels : ['China', 'France', 'GBR', 'Germany', 'Italy', 'Japan', 'KOR', 'Russia', 'USA']}
const yAxis = { labels : ['2000', '2004', '2008', '2012', '2016']};
...
provide('heatmap', [Adaptor]);
</script>
<template>
 <ejs-heatmap :dataSource="heatmapData" :xAxis="xAxis" :yAxis="yAxis"
              height="350px" width="750px" :dataSourceSettings="dataSourceSettings"></ejs-heatmap>
</template>
